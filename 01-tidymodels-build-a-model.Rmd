...
This round of exploration does not have to be absolutely thorough; the point is to  gain insights that will help you get a first reasonably good prototype. But this is an iterative process: once you get a prototype up and running, you can analyze its output to gain more insights and come back to this exploration step.

We end our data exploration with a geographical scatterplot of the data:
...
1. Pick a `model type` and set the `engine`: choose from this [list](https://www.tidymodels.org/find/parsnip/)
2. Set the `mode`: regression or classification
...
Now we can fit the models and collect the performance metrics with `collect_metrics()`:
# Model building
