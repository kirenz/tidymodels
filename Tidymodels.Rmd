...
In this book we'll cover the  [`tidymodels`](https://www.tidymodels.org/) framework, which is a collection of R packages for modeling and machine learning using [tidyverse](https://www.tidyverse.org/) principles to build regression and classification models. Furthermore, we follow the data science lifecycle process proposed by @Wirth2000:
...
```{r visdat-reg, fig.margin = TRUE, echo = TRUE, out.width = "100%", out.height = "100%", fig.cap = "Overview about Data classes"}
library(visdat)
